...
\begin{figure}
    \centering
    \includegraphics[width=0.55\hsize]{figures/trkEff_pt_ttbar_ILD_ls5_v02_monitor.png}
    \includegraphics[width=0.38\hsize]{figures/PResolution_ILD_ls5_v02.png}
    \caption{Left: Simulated tracking efficiency in the full ILD detector, in $t \bar t$ events.  Right: Simulated momentum resolution as a function of the transverse momentum. The different curves correspond to different angular cuts, and to different detector models.}
